...
* **Provider firewall.** Nothing outside `app/desktop`, `app/services/desktop.py`, `app/repositories/desktop.py` and the two routes can read a desktop observation; a structural test pins the importer allowlist.
