...
from tests.conftest import M10_S1_TABLES, M10_S2_TABLES, M10_S3_TABLES, M10_S4_TABLES, M11_S2_TABLES, head_revision, downgrade, migrate, truncate_all
...
def test_migration_0015_widens_dispatches_and_adds_desktop_action_plans(migrated_database_url: str) -> None:
    ...
    try:
        ...
        truncate_all(url, without=("desktop_vision_disclosures", "desktop_captures", *M10_S1_TABLES, *M10_S2_TABLES, *M10_S3_TABLES, *M10_S4_TABLES, *M11_S2_TABLES))
        downgrade(url, "0014")
