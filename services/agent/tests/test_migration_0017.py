...
from tests.conftest import M10_S2_TABLES, M10_S3_TABLES, M10_S4_TABLES, M11_S2_TABLES, head_revision, downgrade, migrate, truncate_all
...
def test_migration_0017_adds_the_document_tables_and_downgrades_only_without_audit_rows(migrated_database_url: str) -> None:
    ...
    try:
        ...
        truncate_all(url, without=(*M10_S2_TABLES, *M10_S3_TABLES, *M10_S4_TABLES, *M11_S2_TABLES))
        downgrade(url, "0016")
