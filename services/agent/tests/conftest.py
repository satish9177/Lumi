...
TRUNCATE_ALL = (
    "TRUNCATE orchestration_resources, orchestration_steps, orchestrations, workflow_values, workflow_candidates, workflow_steps, workflows, project_runs, project_recipes, projects, file_transfers, action_effect_keys, document_answers, document_disclosures, documents, file_refs, file_roots, desktop_dispatches, desktop_answers, desktop_disclosures, desktop_action_plans, "
...
#: Milestone 12 S1 tables: absent before `0023`.
M12_S1_TABLES = ("orchestration_resources",)
