...
class TaskEventType(StrEnum):
    ...
    # Milestone 10 S1: approved documents. Payloads carry ids, formats and counts, never text or a path.
    TASK_DOCUMENT_FILE_ADDED = "task.document_file_added"
    TASK_DOCUMENT_EXTRACTED = "task.document_extracted"
    TASK_DOCUMENT_EXTRACTION_REFUSED = "task.document_extraction_refused"
    TASK_DOCUMENT_DISCLOSURE_REQUESTED = "task.document_disclosure_requested"
    TASK_DOCUMENT_DISCLOSURE_GRANTED = "task.document_disclosure_granted"
    TASK_DOCUMENT_DISCLOSURE_REVOKED = "task.document_disclosure_revoked"
    TASK_DOCUMENT_DISCLOSURE_STARTED = "task.document_disclosure_started"
